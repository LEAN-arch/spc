...
# Replace the ENTIRE 'elif "Process Stability" in method_key:' block with this one.
    ...
    **Application:** This is the Hero's daily duty as the Guardian of the process. Each day, the Villain of Variation will try to sneak past the defenses. This multi-rule system is the vigilant gatekeeper that ensures only valid, trustworthy results are released. It is the core of routine QC in any regulated lab environment.
    ...
    with col2:
        ...
        with tab3:
            st.markdown("**Origin:** Dr. S. Levey and Dr. E. R. Jennings introduced control charts to the clinical lab in the 1950s. Dr. James Westgard later developed the multi-rule system in the 1980s to improve error detection. **From Industry to the Clinic:** The concept of control charts originated with Walter Shewhart in industrial manufacturing in the 1920s. In the 1950s, **Dr. S. Levey and Dr. E. R. Jennings** adapted this powerful tool for the clinical laboratory, creating what is now known as the Levey-Jennings chart. This was a revolutionary step in bringing statistical quality control to healthcare. **The Westgard Revolution:** For decades, labs often used simple ±2σ or ±3σ limits. However, **Dr. James Westgard** recognized that this approach was a blunt instrument—either too prone to false alarms (2s) or not sensitive enough to real problems (3s). In a landmark 1981 paper, he proposed a "multi-rule" system. This system combines several different rules to create a highly sensitive yet specific quality control procedure. The Westgard Rules are now the global standard for clinical laboratory QC and are essential for meeting regulatory requirements from bodies like CLIA, CAP, and ISO 15189.")
